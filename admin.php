  ...
  <body>
    <div class="page-wrapper">
              ...
              <ul class="main-menu">
                ...
                <li class="main-menu__item main-menu__item--has-child">
                  ...
                  <ul class="main-menu__sub-list sub-list--style-2">
                    <li>
                      <a href="food.php"><span>Food</span></a>
                    </li>
                    <li>
                      <a href="vaccine.php"><span>Vaccine</span></a>
                    </li>
                    <li>
                      <a href="research.php"><span>Research</span></a>
                    </li>
                    <li>
                      <a href="employee.php"><span>Employee</span></a>
                    </li>
                    <li>
                      <a href="complaint_list.php"><span>Complaint</span></a>
                    </li>
                    <li>
                      <a href="cage_list.php"><span>Cage</span></a>
                    </li>
                    <li>
                      <a href="foodsupplier.php"><span>Food Suppliers</span></a>
                    </li>
                    <li>
                      <a href="research.php"><span>Research</span></a>
                    </li>
                    <!-- <li>
                      <a href="taxonomy_list.php"
                ...
                <li class="main-menu__item">
                  <a class="main-menu__link" href="Museum.html"
                    ><span>Museum</span></a
                  >
                </li>
      ...
      <main class="main">
        ...
        <section class="promo">
          <div class="promo-slider">
            <div class="promo-slider__item promo-slider__item--style-2">
              <picture>
                <source srcset="img/promo/promo_1.jpg" media="(min-width: 992px)" />
                <img class="img--bg" src="img/promo/promo_1.jpg" alt="img" />
              </picture>
              <div class="container">
                <div class="row">
                  <div class="col-xl-7">
                      ...
                      <div class="align-container__item">
                        ...
                        <div class="promo-slider__wrapper-2">
                          <p class="promo-slider__subtitle">
                            Animals World accreditation standards. Members are
                            proactive in both undertaking and applying animal
                            welfare scientific research, contributing
                          </p>
                        </div>
            ...
            <div class="promo-slider__item promo-slider__item--style-2">
              <picture>
                <source srcset="img/promo/promo_2.jpg" media="(min-width: 992px)" />
                <img class="img--bg" src="img/promo/promo_2.jpg" alt="img" />
              </picture>
              <div class="container">
                <div class="row">
                  <div class="col-xl-6 offset-xl-6">
                    <div class="align-container">
                      <div class="align-container__item">
                        <div class="promo-slider__wrapper-1">
                          <h2 class="promo-slider__title">
                            <span>AnimalWorld</span><br />
                            <span>Biggest Cats</span>
                          </h2>
                        </div>
                        <div class="promo-slider__wrapper-2">
                          <p class="promo-slider__subtitle">
            ...
            <div class="promo-slider__item promo-slider__item--style-3">
              <picture>
                <source srcset="img/promo/promo_3.jpg" media="(min-width: 992px)" />
                <img class="img--bg" src="img/promo/promo_3.jpg" alt="img" />
              </picture>
              <div class="container">
                <div class="row">
          ...
          <div class="promo-pannel">
            <!-- <div class="promo-pannel__details">
							...
							<p><strong>Location:</strong> av. Washington 165, NY CA 54003</p>
							<p><strong>Phone:</strong> <a class="promo-pannel__link" href="tel:+31859644725">+31 85 964 47 25</a> <a class="promo-pannel__link" href="tel:+31859644725">+31 65 792 63 11</a></p>
							<p><strong>Openning hours:</strong> 9:00 AM - 5:00 PM</p>
						</div><a class="video-trigger" href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><img class="img--bg" src="img/video-block.jpg" alt="image"/><span class="video-trigger__icon"><span>Live Cam</span><i class="fa fa-play" aria-hidden="true"></i></span></a> -->
          </div>
          <!-- promo pannel end-->
        </section>
        <!-- promo end-->
              ...
              <div class="col-lg-6 col-xl-5">
                <div class="info-box">
                  <div class="info-box__inner">
                    <img class="img--bg" src="img/about-us.jpg" alt="img" />
                    <div class="heading heading--primary">
                      <span class="heading__pre-title">history</span>
                      <h2 class="heading__title color--white">
                        <span>Explore </span><br />
                        <span>The diversity</span>
                      </h2>
                    </div>
                    <p>
                       Today, less than 4,000 tigers remain
                      worldwide.Save tigers!
                    </p>
                    <a class="info-box__link" href="volunteer.html">Donate!</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-xl-6 offset-xl-1">
                <div class="heading heading--primary heading--style-2">
                  ...
                  <h2 class="heading__title">
                    <span>Bangladesh National zoo</span><br />
                    <span>first zoo of the country</span>
                  </h2>
                </div>
                <p>
                  <strong
                    ...
                    arrowtooth eel french angelfish yellowfin pike unicorn
                    fish.</strong
                  >
                </p>
                <p class="bottom-50">
                  ...
                  killifish seamoth triplefin blenny
                </p>
                <!-- <div class="row offset-30">
                  <div class="col-6 col-sm-3">
                    <div class="brand-item bottom-30">
                      <img
                ...
                <a class="button button--primary top-50" href="#">More about</a>
              </div>
            </div>
          </div>
        </section>
        <!-- section end-->
        <!-- section start-->
        <section class="section no-padding-bottom home-animals">
          <div class="container">
            <div class="row align-items-end bottom-70">
              <div class="col-xl-7">
                <div class="heading heading--primary heading--style-2">
                  <span class="heading__pre-title">Our animals</span>
                  <h2 class="heading__title">
                    <span>Awesome AnimalS in</span> <span>our Zoo</span>
                  </h2>
                  <p>
                    Rudderfish long-finned pike--razorfish menhaden paradise
                    fish, barramundi oceanic flyingfish. Fangtooth yellowtail
                    banded killifish seamoth triplefin blenny desert pupfish
                    crocodile shark catfish cutlassfish broadband dogfish
                    whalefish.
                  </p>
                </div>
              </div>
                  ...
                  <div class="col-md-4">
                    <div class="counter-item counter-item--front-1">
                      ...
                      <div class="counter-item__lower">
                        <span class="js-counter">850</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="counter-item counter-item--front-1">
                      ...
                      <div class="counter-item__lower">
                        <span class="js-counter">230</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="counter-item counter-item--front-1">
                      ...
                      <div class="counter-item__lower">
                        <span class="js-counter">160.000</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row offset-30">
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a class="animal-item text-center card-first" href="#">
                  <div class="animal-item__icon color--primary">
                    <svg class="icon">
                      <use xlink:href="#spider"></use>
                    </svg>
                  </div>
                  <h6 class="animal-item__title">Invertebrates</h6></a
                >
              </div>
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a
                  class="animal-item text-center color--primary card-second"
                  href="#"
                >
                  ...
                  <h6 class="animal-item__title">Bulls</h6></a
                >
              </div>
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a
                  class="animal-item text-center background--dark color--white card-third"
                  href="#"
                >
                  <div class="animal-item__icon">
                    <svg class="icon">
                      <use xlink:href="#giraffe"></use>
                    </svg>
                  </div>
                  <h6 class="animal-item__title">Girafes</h6></a
                >
              </div>
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a
                  class="animal-item text-center background--orange color--primary card-fourth"
                  href="#"
                >
                  <div class="animal-item__icon">
                    <svg class="icon">
                      <use xlink:href="#elep"></use>
                    </svg>
                  </div>
                  <h6 class="animal-item__title">Mammals</h6></a
                >
              </div>
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a
                  class="animal-item text-center color--primary card-fifth"
                  href="#"
                >
                  <div class="animal-item__icon">
                    <svg class="icon">
                  ...
                  <h6 class="animal-item__title">Birds</h6></a
                >
              </div>
              <div class="col-sm-6 col-md-4 col-xl-2">
                <a
                  class="animal-item text-center background--dark color--white card-sixth"
                  href="#"
                >
                  <div class="animal-item__icon">
                    <svg class="icon">
                  ...
                  <h6 class="animal-item__title">Fishes</h6></a
                >
              </div>
            </div>
          </div>
        ...
        <section class="section gallery no-padding-bottom">
            ...
            <div class="row bottom-50 align-items-end">
              <div class="col-md-7 col-lg-6">
                <div class="heading heading--style-2">
                  <span class="heading__pre-title">Our Gallery</span>
                  <h2 class="heading__title no-margin-bottom">
                    <span>Shots</span><br />
                    <span>from our zoo</span>
                  </h2>
                </div>
              </div>
              <div class="col-md-5 col-lg-6 text-right d-none d-md-block">
                <a class="button button--primary" href="#">Discover animals</a>
              </div>
            </div>
          </div>
          <div class="row no-gutters gallery-masonry">
            <div class="col-sm-6 col-md-3 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-1"
                href="img/gallery_1.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_1.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Mamals</span><span>Giraffes</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-6 gallery-masonry__item">
              <a
                ...
                href="img/gallery_2.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_2.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Mamals</span><span>Lions</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-3 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-3"
                href="img/gallery_3.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_3.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Birds</span><span>Parrots</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-3 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-1"
                href="img/gallery_4.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_4.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Reptiles</span><span>Lizards</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-3 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-1"
                href="img/gallery_5.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_5.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Fishes</span><span>Clown</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-3 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-1"
                href="img/gallery_6.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_6.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Mamals</span><span>Monkeys</span>
                </div></a
              >
            </div>
            <div class="col-sm-6 col-md-6 gallery-masonry__item">
              <a
                class="gallery-masonry__img gallery-masonry__item--height-4"
                href="img/gallery_7.jpg"
                data-fancybox="gallery"
                ><img class="img--bg" src="img/gallery_7.jpg" alt="img" />
                <div class="gallery-masonry__description">
                  <span>Mamals</span><span>Elephants</span>
                </div></a
              >
            </div>
          </div>
        ...
        <section class="section front-events background--gray">
          <div class="container">
            <div class="row">
              <div class="col-lg-10 col-xl-7">
                <div
                  class="heading heading--primary heading--style-2 bottom-50"
                >
                  <span class="heading__pre-title">Events</span>
                  <h2 class="heading__title no-margin-bottom">
                    <span>what happening</span><br />
                ...
                <div class="nearest-item">
                  <div class="row align-items-center">
                    <div class="col-md-4">
                      <div class="nearest-item__img">
                        <img
                          class="img--bg img-fluid"
                          src="/img/events/event-1.png"
                          alt="img"
                        />
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="nearest-item__description">
                        <a class="nearest-item__link" href="#"
                          >World Animal Day</a
                        ><span class="nearest-item__category"> </span>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="nearest-item__date">
                        <span>11 - 10 PM</span><span>4 October </span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="nearest-item">
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                      <div class="nearest-item__date">
                        <span>13 - 15 PM</span><span>10 November</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="nearest-item">
                  <div class="row align-items-center">
                    <div class="col-md-4">
                      <div class="nearest-item__img">
                        <img class="img--bg" src="/img/events/event-3.jpg" alt="img" />
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="nearest-item__description">
                        <a class="nearest-item__link" href="#">Magic Shows</a
                        ><span class="nearest-item__category"> </span>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="nearest-item__date">
                        <span>15 - 18 PM</span><span>10 November</span>
                      </div>
                    </div>
                  </div>
                </div>
                <a
                  class="front-events__button button button--primary"
                  href="events.html"
                  >See all Events</a
                >
              </div>
          ...
          <div class="main-event">
            <img
              class="img--bg img-fluid cow"
              src="/img/cow-1715829__480.jpg"
              alt="img"
            />
            <div class="main-event__inner">
              <div class="heading heading--primary heading--style-2">
                <span class="heading__pre-title">Main Event</span>
                <h2 class="heading__title">
                  <span>Cow Appreciation Day</span><br />
                  <span>in our Zoo</span>
                </h2>
              </div>
              <p>
                Cow Appreciation Day takes place on July 14, 2023. It is a day
                to remind us how integral cows are to our daily life. In some
                regions, such as parts of India, cows have significant religious
                meaning. Cows are sometimes considered as the oldest form of
                wealth. This text has been taken from www.cute-calendar.com
              </p>
              <div class="main-event__date">
                <span>14 - 18 PM</span><span>14 July</span>
              </div>
              <a class="button main-event__button button--primary" href="#"
                >Discover</a
              >
            </div>
          </div>
        ...
        <section class="section">
          <img
            class="section__bg t50 r0"
            src="img/testimonials_bg.png"
            alt="bg"
          />
        ...
        <section class="section no-padding-top no-padding-bottom">
          <div class="map-banner">
            <img class="img--bg" src="img/cta_bg.jpg" alt="img" />
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  <div class="align-container">
                    <div class="align-container__item">
                      <div class="heading heading--primary">
                        <h2 class="heading__title no-margin-bottom">
                          <span>Map of Animals world</span> <span>Zoo</span>
                        </h2>
                      </div>
            ...
            <div class="row bottom-50">
              <div class="col-12">
                <div class="heading heading--primary heading--center">
                  ...
                  <h2 class="heading__title no-margin-bottom">
                    <span>People Who</span> <span>support Us</span>
                  </h2>
                </div>
              </div>
            </div>
              ...
              <div class="col-12">
                <div class="logos-slider">
                  <div class="logos-slider__item">
                    <img class="img-fluid" src="img/logo/org1.png" alt="logo" />
                  </div>
                  <div class="logos-slider__item">
                    <img src="img/logo/org2.jpg" alt="logo" />
                  </div>
                  <div class="logos-slider__item">
                    <img src="img/logo/org3.webp" alt="logo" />
                  </div>
                  <div class="logos-slider__item">
                    <img src="img/org4.svg" alt="logo" />
                  </div>
                  <div class="logos-slider__item">
                    <img src="img/logo/org5.png" alt="logo" />
                  </div>
                </div>
