  ...
  <body>
    ...
    <table id="example" class="table table-striped" style="width:100%">
        <thead>
            <tr>
                <!-- <th>SI No</th> -->
                <th>Foodsupplier ID</th>
                <th>Foodsupplier Name</th>
                <th>Foodsupplier Gender</th>
                <th>Foodsupplier DOB</th>
                <th>Foodsupplier Phoneno</th>
                <th>Food Source</th>
                <th>Food Supplied</th>
                <th>Food Amount</th>
                <th>Food Price</th>
                <th>Foodsupplier date</th>
            </tr>
        </thead>
        <tbody>

                   <?php
                                $sql = "select *from FOOD_SUPPLIER";
                                ...
                                <tr>
                                  ...
                                  <td>" . $row["FS_GENDER"] . "</td>
                                  <td>" . $row["FS_DOB"] . "</td>
                                  <td>" . $row["FS_PHONENO"] . "</td>
                                  <td>" . $row["FS_FOODSOURCE"] . "</td>
                                  <td>" . $row["FS_FOODSUPPLIED"] . "</td>
                                  <td>" . $row["FS_FOODAMOUNT"] . "</td>
                                  <td>" . $row["FS_FOODPRICE"] . "</td>
                                  <td>" . $row["FS_DATE"] . "</td>
                                  </tr>
                                ";
                                }
