  ...
  <body>
    ...
    <table id="example" class="table table-striped" style="width:100%">
        ...
        <tbody>
                   ...
                   <?php
                                $sql = "select ANIMAL_ID,ANIMAL_NAME,CURRENT_CONDITION,PRICE,CAGE_NO,SPECIES from animal ";
                                ...
                                <td>" . $row["CAGE_NO"] . "</td>
                                <td>" . $row["SPECIES"] . "</td>
                                <td><a href ='animal_profile.php?un=" . $row["ANIMAL_ID"] . "'>PROFILE</a></td>
                                </tr>
                                ";
                                }
                        ...
                        <div class="row">
                            <form method="post">
                                <div class=" text-center">
                                    ...
                                    <input type='text' name="ritem_name" placeholder=" Remove Animal">
                                ...
                                <div class="text-center" style="margin-top: 5px; margin-bottom:10px">
                                    ...
                                    <!-- <button type="button" class="btn btn-outline-danger" name="b1">Submit</button> -->
