            ...
            <div class="col-md-8">
              <div class="card mb-3">
                ...
                <div class="row">
                    ...
                    <?php
                              echo $EMPLOYEEjoinMember["EMPLOYEE_ID"];
                            ?>
                    </div>
                  </div>
                  <hr></hr>
                  ...
                  <hr>
                  <?php 
                   $c_detail=$EMPLOYEEjoinMember["EMPLOYEE_ID"];
                   $sql= "select * FROM cdetailsview WHERE EMPLOYEE_ID='$c_detail'";
                   $stid = oci_parse($conn, $sql);
                   $r = oci_execute($stid);
                   $a = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS);
                   if($a!=null){
                echo
                  "<div class='row'>
                    <div class='col-sm-3'>
...
?>
              ...
              <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="">Edit Designation and Salary</a>
                    </div>
